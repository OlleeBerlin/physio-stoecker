      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center space-x-6">
            ...
            <a 
              href="tel:030853587" 
              className="hidden sm:inline-flex items-center px-4 py-2 bg-orange-400 hover:bg-orange-500 text-white text-sm font-medium transition-colors rounded-full"
            >
              Termin vereinbaren
            </a>
          ...
          <div className="lg:hidden border-t border-gray-200 bg-white">
            <nav className="px-6 py-6 space-y-6">
              ...
              <div className="pt-6 border-t border-gray-200">
                <a 
                  href="tel:030853587" 
                  className="inline-flex items-center px-4 py-2 bg-orange-400 hover:bg-orange-500 text-white text-sm font-medium transition-colors rounded-full"
                >
                  Termin vereinbaren
                </a>
              </div>
